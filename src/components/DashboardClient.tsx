...
export default function DashboardClient({ userProfile, projects, activities, stats }: { userProfile: any, projects: any[], activities: any[], stats: any }) {
  ...
  return (
    <div ref={containerRef} className="flex h-screen bg-black text-white overflow-hidden font-sans selection:bg-[hsl(76,85%,67%)] selection:text-black">
      ...
      {/* Main Content */}
      <main className="flex-1 flex flex-col relative z-10 h-screen overflow-y-auto overflow-x-hidden pb-20 md:pb-10">
