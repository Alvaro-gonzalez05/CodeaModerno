...
export default function Process() {
  ...
  return (
    <>
      ...
      <section 
        ref={sectionRef} 
        className="process-fixed-section fixed top-0 left-0 w-full h-screen bg-white text-black py-20 flex flex-col items-center justify-center translate-x-full rounded-[60px] overflow-hidden z-[25]"
      >
          ...
          <div className="w-full md:w-1/2 h-[500px] flex justify-center items-center relative">
            ...
            >
              <Card className="bg-[#F5F5F5] border border-black/10 p-6 flex flex-col justify-start text-black">
                ...
                <img src="/a.png" alt="Análisis" className="w-full h-48 object-contain mb-6 rounded-lg bg-white/50" />
                <h3 className="text-3xl font-bold mb-2">1 Análisis</h3>
              ...
              <Card className="bg-[#F5F5F5] border border-black/10 p-6 flex flex-col justify-start text-black">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/a.png" alt="Desarrollo" className="w-full h-48 object-contain mb-6 rounded-lg bg-white/50" />
                <h3 className="text-3xl font-bold mb-2">2 Desarrollo</h3>
                <p className="text-gray-600 leading-relaxed text-sm">
              ...
              <Card className="bg-[#F5F5F5] border border-black/10 p-6 flex flex-col justify-start text-black">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/a.png" alt="Despliegue" className="w-full h-48 object-contain mb-6 rounded-lg bg-white/50" />
                <h3 className="text-3xl font-bold mb-2">3 Despliegue</h3>
                <p className="text-gray-600 leading-relaxed text-sm">
        ...
        <div ref={textRef} className="absolute bottom-10 left-0 w-full text-center z-20 opacity-0">
