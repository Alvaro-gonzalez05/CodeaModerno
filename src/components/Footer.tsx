...
export default function Footer() {
  return (
    <footer className="relative z-40 bg-white text-black pt-12 pb-10 rounded-t-[60px] -mt-10">
      <div className="w-full px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 w-full items-start md:items-center pt-4">
            ...
            <div className="md:col-span-6 flex flex-col items-center justify-center gap-4">
                    ...
                    <a href="https://wa.me/5492616977056?text=Hola%20vengo%20desde%20la%20pagina%20oficial%20de%20Codea%20Desarrollos%2C%20estoy%20interesado%20en......" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-[#25D366] text-white px-6 py-2.5 rounded-full hover:bg-[#128C7E] transition-all font-bold text-sm md:text-base shadow-md hover:shadow-lg transform hover:-translate-y-1 duration-200">
            ...
            <div className="md:col-span-3 flex justify-center md:justify-end gap-10 md:gap-12">
                <div className="flex flex-col gap-4">
                    ...
                    <Link href="/work" className="text-gray-500 hover:text-black transition-colors">Trabajos</Link>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <a href="https://www.instagram.com/codea.desarrollos/" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-black transition-colors">Instagram</a>
                    <a href="https://www.tiktok.com/@codeadesarrollos" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-black transition-colors">TikTok</a>
                </div>
            </div>
        </div>
