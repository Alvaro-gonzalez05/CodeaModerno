    ...
    <>
      ...
      >
        ...
        <div ref={cardsContainerRef} className="container mx-auto px-4 relative z-0">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-4 md:px-24 max-w-6xl mx-auto">
            {tools.map((tool, index) => (
              <div 
                key={index} 
                ref={el => { cardsRef.current[index] = el }}
                className="bg-white text-black rounded-[40px] p-10 hover:scale-[1.02] transition-transform duration-500 group relative overflow-hidden"
              >
                <div className="absolute top-0 right-0 w-32 h-32 bg-gray-100 rounded-bl-[100px] -mr-4 -mt-4 z-0 transition-colors group-hover:bg-gray-200"></div>
                ...
                <div className="relative z-10" ref={el => { cardContentsRef.current[index] = el }}>
                  ...
                  <h3 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight">{tool.name}</h3>
                  <p className="text-lg text-gray-600 leading-relaxed mb-8">
                    {tool.description}
                  </p>
                  
                  <div className="flex items-center gap-3 text-lg font-bold group-hover:gap-5 transition-all duration-300">
                    <span>Explorar</span>
        ...
        {tools.map((tool, index) => (
          <div 
            ...
            className="absolute inset-0 w-full h-full bg-white text-black z-50 flex items-center justify-center opacity-0 invisible"
          ...
          >
            <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-12 md:gap-24">
              ...
              <div className="w-full md:w-1/2 text-left">
                ...
                <h2 className="text-5xl md:text-7xl font-bold mb-6 tracking-tighter">{tool.name}</h2>
        ...
        {/* Footer Text */}
        <div ref={footerTextRef} className="absolute bottom-20 left-0 w-full text-center z-20 opacity-0">
